...
[ 
  ...
  "make_rectangle" >:: (fun c ->
     ...
     let ra  = rectangle_area r in
       begin
         check_within "segment length rl" (segment_length rl) 2.0 eps;
         check_within "segment length ru" (segment_length ru) 2.0 eps;
         check_within "segment length rlf" (segment_length rlf) 39.6 eps;
         check_within "segment length rrt" (segment_length rrt) 39.6 eps;
